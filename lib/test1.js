...
var TObj1 = /** @class */ (function (_super) {
    ...
    TObj1.prototype.DoCreate = function (fn) {
        DebugLog('TObj1/Create', '35');
        _super.prototype.DoCreate.call(this, fn);
    };
    return TObj1;
}(main_1.TObject));
var TObj2 = /** @class */ (function (_super) {
    ...
    TObj2.prototype.DoCreate = function (fn) {
        var _this = this;
        DebugLog('TObj2/Create', '35');
        //simulated async event
        setTimeout(function () {
            _super.prototype.DoCreate.call(_this, fn);
        }, 1500);
    };
    return TObj2;
}(main_1.TObject));
var TObj3 = /** @class */ (function (_super) {
    ...
    TObj3.prototype.DoCreate = function (fn) {
        var _this = this;
...
var TObj4 = /** @class */ (function (_super) {
    ...
    TObj4.prototype.DoCreate = function (fn) {
        var _this = this;
